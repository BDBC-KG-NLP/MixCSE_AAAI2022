...
from mixcse.models_mix import RobertaForCL, BertForCL
from mixcse.trainers import CLTrainer
...
def main():
    ...
    if extension == "txt":
        extension = "datasets_cache/text.py"
        # extension = "text"
    if extension == "csv":
        extension = "datasets_cache/csv.py"
    ...
    eval_dataset = Construct_EvaldDtaset(data_args.eval_path,tokenizer)
